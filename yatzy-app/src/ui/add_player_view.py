...
class PlayersView:
    ...
    def _initialize_player_field(self):
        player_label = ttk.Label(master=self._frame, text='Come up with a player name for yourself...')
    ...
    def _initialize(self):
        ...
        add_button = ttk.Button(master=self._frame, text='Add a player', command=self.add_player)
        play_button = ttk.Button(master=self._frame, text='Play!', command=self.playbutton)
