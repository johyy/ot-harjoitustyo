...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_salda_oikein(self):
    ...
    def test_edullisesti_syonti_kun_rahaa_vain_sen_verran(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.0 euroa")

    def test_maukkaasti_syonti_kun_rahaa_vain_sen_verran(self):
